...
public class WebserviceConstants {
    ...
    public static final String TEACHER_ASSIGN_POINT = "point_registration_webservice_v4.php";
    ...
    public static final String TEACHER_UPDATE_PROFILE = "update_teacher_profile_webservice_V2.php";
    public static final String TEACHER_DISPLAY_PROFILE = "display_teacher_profile.php";
