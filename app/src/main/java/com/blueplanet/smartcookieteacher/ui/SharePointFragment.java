 ...
 */
public class SharePointFragment extends Fragment {

    private RelativeLayout _rlProgressbar;
    private ProgressBar _progressbar;
    private TextView _tvPleaseWait;
    private ListView _teacherListView;
    private SharePointFragmentController _shairpointtController = null;
    ...
    private TeacherSharePointAdapter _adapter;
    ...
    private void _registerUIListeners() {
        ...
        _teacherListView.setOnScrollListener(_shairpointtController);
        _teacherListView.setOnItemClickListener(_shairpointtController);
    ...
    public void onDestroy() {
        ...
        super.onDestroy();
        if (_shairpointtController != null) {
            _shairpointtController.clear();
            _shairpointtController = null;
        }
        if(_adapter !=null)
        {
            _adapter=null;
