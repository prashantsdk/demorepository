 ...
 */
public class DisplaySubjectFeatureController implements IEventListener {
     ...
     */
    private DisplaySubjectFeatureController() {
     ...
     */
    public static DisplaySubjectFeatureController getInstance() {
        if (_searchSubjectFeatureController == null) {
            _searchSubjectFeatureController = new DisplaySubjectFeatureController();
        }
        return _searchSubjectFeatureController;
    }

    public void searchSubjectFromServer( String school_id, String name_key) {
        _registerEventListeners();
        DisplayTeacherSubject searchFriends = new DisplayTeacherSubject(school_id, name_key);
        searchFriends.send();
    }
    ...
    public int eventNotify(int eventType, Object eventObject) {
        ...
        switch (eventType) {
            ...
            case EventTypes.EVENT_TEACHER_SUBJECT:
                if (errorCode == WebserviceConstants.SUCCESS) {
                    ...
                    eventNotifier.eventNotifyOnThread(EventTypes.EVENT_TEACHER_UI_SUBJECT,
                            serverResponse);
                    ...
                    if (statusCode == HTTPConstants.HTTP_COM_NO_CONTENT) {
                        ...
                        EventNotifier eventNotifierUI =
                                NotifierFactory.getInstance().getNotifier(
                                        NotifierFactory.EVENT_NOTIFIER_TEACHER);
                        eventNotifierUI.eventNotifyOnThread(EventTypes.EVENT_TEACHER_NOT_UISUBJECT,
                                serverResponse);
