 ...
 */
public class GetAllSubject extends SmartCookieTeacherService {
     ...
     * @param tid,schoolid
     */
    public GetAllSubject(String tid, String schoolID) {
        _teacherID = tid;
        _schoolID = schoolID;
    }
    ...
    protected String formRequest() {
        return WebserviceConstants.HTTP_BASE_URL +
                WebserviceConstants.BASE_URL + WebserviceConstants.ALL_SUBJECT_WEB_SERVICE;
    }
    ...
    protected void parseResponse(String responseJSONString) {
        ...
        try {
            ...
            ArrayList<TeacherAllSubject> subjectList = new ArrayList<>();
            ...
            if (statusCode == HTTPConstants.HTTP_COMM_SUCCESS) {
                ...
                for (int i = 0; i < responseData.length(); i++) {
                    ...
                    TeacherAllSubject teacherallSubject = new TeacherAllSubject(tsubID, tschoolID, tsubcode, tsubName,
                            tsubDivisionId, tsubSemesterID, tsubBranchID, tsubDepartmentID, tsubCourseLevelID);

                    subjectList.add(teacherallSubject);
    ...
    public void fireEvent(Object eventObject) {
        ...
        notifier.eventNotify(EventTypes.EVENT_ALL_SUBJECT, eventObject);
