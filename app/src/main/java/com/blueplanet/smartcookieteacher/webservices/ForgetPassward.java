...
/**
 * Created by 1311 on 03-06-2016.
 */
public class ForgetPassward extends SmartCookieTeacherService {

    private String _entity,_email;
    private final String _TAG = this.getClass().getSimpleName();

    public ForgetPassward(String entity,String email
    ) {
    ...
    protected String formRequest() {
        ...
        return WebserviceConstants.HTTP_BASE_URL +
                WebserviceConstants.BASE_URL + WebserviceConstants.FORGET_PASSWARD_WEB_SERVICE;
    }
    ...
    protected JSONObject formRequestBody() {
        ...
        try {
            ...
            requestBody.put(WebserviceConstants.EMAIL, _email);
    ...
    public void fireEvent(Object eventObject) {
        ...
        notifier.eventNotify(EventTypes.EVENT_FORGET_PEASSWARD, eventObject);
