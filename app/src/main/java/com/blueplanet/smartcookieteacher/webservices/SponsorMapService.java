            ...
            if (statusCode == HTTPConstants.HTTP_COMM_SUCCESS) {
                ...
                for (int i = 0; i < responseData.length(); i++) {
                  ...
                  //  JSONObject jsonObject=jsonObjectl.getJSONObject(WebserviceConstants.KEY_POST);
                    ...
                    String SPONSOR_CITY = jsonObject.optString(WebserviceConstants.KEY_SPONSOR_CITYY);
                    String SPONSOR_COUNTRY = jsonObject.optString(WebserviceConstants.KEY_SPONSOR_COUNTRYY);
                    String SPONSOR_LAT = jsonObject.optString(WebserviceConstants.KEY_SPONSOR_LATT);
                    String SPONSOR_LONG = jsonObject.optString(WebserviceConstants.KEY_SPONSOR_LONGG);
                    String SPONSOR_DISTANCE = jsonObject.optString(WebserviceConstants.KEY_SPONSOR_DISTANCEE);
                    String KEY_SPONSOR_CATEGORY = jsonObject.optString(WebserviceConstants.KEY_SPONSOR_CATEGORYY);
                    String KEY_SPONSOR_IMG_PATH = jsonObject.optString(WebserviceConstants.KEY_SPONSOR_IMG_PATHH);
                    try {
