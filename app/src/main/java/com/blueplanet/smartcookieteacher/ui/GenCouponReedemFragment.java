...
/**
 * Created by Sayali on 1/17/2018.
 */
public class GenCouponReedemFragment extends Fragment {

    private View _view;
    private TextView _txtvalidity, _txtPoints;
    private GenerateCouponLog _genCoupon;
    private ArrayList<GenerateCouponLog> _genCouList;
    private GenCouponReddemController _couponReedemController = null;
    Bitmap bitmap = null;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        _initUI();
        _genCoupon = GenerateCouLogFeatureController.getInstance().get_coupLog();
        Loadqrcode();
        if (_genCoupon != null) {
            String cpId = _genCoupon.get_gencoupon_id();
    ...
    private void _setDataOnUi() {
        ...
        if (_genCoupon != null) {
            getActivity().runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    _txtvalidity.setText(_genCoupon.get_generate_validity_date());
                    _txtPoints.setText(_genCoupon.get_couponPoint());
