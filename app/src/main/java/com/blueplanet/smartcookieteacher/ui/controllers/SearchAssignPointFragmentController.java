 ...
 */
public class SearchAssignPointFragmentController implements OnClickListener, IEventListener, OnItemSelectedListener, SeekBar.OnSeekBarChangeListener {
    private SearchAssignPointFragment _assignPointFragment;
    private View _view;
    ...
    private EditText txt_point2, _comment;
    ...
    public void onClick(final View view) {
        ...
        final ImageView imgCircle =  _view.findViewById(R.id.imgSelectedOption);
