 ...
 */
public class GenCouponReddemController {

    private GenCouponReedemFragment _couponReedemFragment = null;
    ...
    public GenCouponReddemController (GenCouponReedemFragment couponReedemFragment,
                                          View view) {
